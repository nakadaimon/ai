...
This folder contains instructions and frameworks for building structured AI agents. The focus is on defining roles, memory management, and decision-making loops.
...
2. Paste it into your agent's system instructions.
3. Adjust the parameters based on your specific use case.
