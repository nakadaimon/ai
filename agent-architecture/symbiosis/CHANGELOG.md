...
All notable changes to the Symbiosis manifesto, from the previously published version (`memento/semantic/ideas/published/symbiosis.md`, unversioned) through v2.8.0.

Versions 2.4.0 onward were driven by blind onboarding tests — each version was tested by simulating a first-time user being bootstrapped through the manifesto, and findings were applied to the next version. Test reports live alongside the manifesto versions in this folder. Methodology details at the bottom.
...
The starting point of this iteration. Compared to the previously published version (`published/symbiosis.md`, no version footer), v2.3.0 introduced:
...
The 2.3.0 run was the baseline test for the iteration. Report at `onboarding-test-report-2.3.0.md`.

---

## Methodology

Each version from 2.5.0 onward was validated via a blind onboarding test:

1. Spawn an orchestrator agent with the orchestrator instructions (`memento/procedural/recipies/symbiosis-onboarding-test-orchestrator.md`).
...
Reports for each tested version live in this folder as `onboarding-test-report-X.Y.Z.md`.
